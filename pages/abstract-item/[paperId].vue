        ...
        <el-form class="form" ref="formRef" :model="data" :rules="formRules" labelPosition="top">
            ...
            <div class="main-form">
                <div class="left-seciton">
                    <el-form-item :label="$t('common.type')" prop="absType">
                ...
                <div class="right-section">
                    ...
                    <el-form-item class="allAuthors" :label="$t('common.allAuthors1')" prop="allAuthor">
                        <el-input type="textarea" v-model="data.allAuthor" :placeholder="$t('common.allAuthors')"></el-input>
                    </el-form-item>
                    <el-form-item class="allAuthors" :label="$t('common.allAuthorsAffiliation1')" prop="allAuthorAffiliation">
    ...
    formEl.validate(async (valid) => {
        if (valid) {
            ...
            if (res.code === 200) {
                ...
                router.push(localePath('/abstract'));
            } else {
